...
public class clsMessaging
{
    ...
    public Boolean SuccessMessage(string strMsg)
    {
        ...
        string funcCall = "<script language='javascript'>swal('" + successMsg[rnd.Next(0,7)] + "!', '" + strMsg + "', 'success')</script>";
    ...
    public Boolean SuccessMessageRedirect(string strMsg, string strURL)
    {
        ...
        Random rnd = new Random();
        var pge = HttpContext.Current.CurrentHandler as Page;
        string funcCall = "<script language='javascript'>swal({   title: '" + successMsg[rnd.Next(0, 7)] + "!',   text: '" + strMsg + "',   type: 'success',   showCancelButton: false,   closeOnConfirm: false,   showLoaderOnConfirm: true, }, function(){ window.location='"+ strURL + "';    });</script>";
        pge.ClientScript.RegisterClientScriptBlock(this.GetType(), "JSScript", funcCall);
        return true;
    }
    ...
    public Boolean ErrorMessage(string strMsg)
    {
        ...
        Random rnd = new Random();
        var pge = HttpContext.Current.CurrentHandler as Page;
        string funcCall = "<script language='javascript'>swal('" + successMsg[rnd.Next(0, 7)] + "!', '" + strMsg + "', 'error')</script>";
        pge.ClientScript.RegisterClientScriptBlock(this.GetType(), "JSScript", funcCall);
        return true;
    }
    ...
    public Boolean ErrorMessageRedirect(string strMsg, string strURL)
    {
        ...
        Random rnd = new Random();
        var pge = HttpContext.Current.CurrentHandler as Page;
        string funcCall = "<script language='javascript'>swal({   title: '" + successMsg[rnd.Next(0, 7)] + "!',   text: '" + strMsg + "',   type: 'error',   showCancelButton: false,   closeOnConfirm: false,   showLoaderOnConfirm: true, }, function(){ window.location='" + strURL + "';    });</script>";
        pge.ClientScript.RegisterClientScriptBlock(this.GetType(), "JSScript", funcCall);
        return true;
    }
    ...
    public Boolean ToastMessage(string strMsg)
    {
        ...
        Random rnd = new Random();
        var pge = HttpContext.Current.CurrentHandler as Page;
        string funcCall = "<script language='javascript'>toastr.info('Are you the six fingered man?');</script>";
        pge.ClientScript.RegisterClientScriptBlock(this.GetType(), "JSScript", funcCall);
        return true;
    }
      ...
      public Boolean HTML5notification(string strMsg)
    {
        ...
        Random rnd = new Random();
        var pge = HttpContext.Current.CurrentHandler as Page;
        string funcCall = "<script language='javascript'></script>";
        pge.ClientScript.RegisterClientScriptBlock(this.GetType(), "JSScript", funcCall);
        return true;
    }
